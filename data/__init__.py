...
from data.core_dataset import core_train, core_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='caption_core':   
        train_dataset = core_train(transform_train, config['image_root'], config['ann_root'], prompt=config['prompt'])
        val_dataset = core_eval(transform_test, config['image_root'], config['ann_root'], 'val')
        test_dataset = core_eval(transform_test, config['image_root'], config['ann_root'], 'test')   
